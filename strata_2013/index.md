...
1. You can preprocess and featurize the data yourself by following along with the parts of this exercise. To skip ahead to exercise 2 where we start examining the data set we will input to K means, just copy and paste all of the code from [our solutions](https://docs.google.com/document/pub?id=1ntZOrSHeT1QRMKJUcUh2a1F9KwUn0RmyLx0P4CflOvE#h.sixbakn14lw5) to preprocess the data.
...
2. In this exercise, we examine the preprocessed data.
    ...
    - Count the number of records in the preprocessed data.  Recall that we potentially threw away some data when we filtered out records with zero views in a given hour.
     ...
     Feel free to compare your answer to our [exercise solutions](https://docs.google.com/document/pub?id=1ntZOrSHeT1QRMKJUcUh2a1F9KwUn0RmyLx0P4CflOvE#h.y53wwtyrkow1).
   ...
   - Print the feature vectors for the Wikipedia articles with project code “en” and the following titles: Computer_science, Machine_learning.  The second line below shows another option for printing arrays in a readable way at the command line.
     ...
     ~~~
      ...
      Again, you can compare to our [exercise solutions](https://docs.google.com/document/pub?id=1ntZOrSHeT1QRMKJUcUh2a1F9KwUn0RmyLx0P4CflOvE#h.y53wwtyrkow1).
...
Now, try to solve the following problem using Spark. We provide less guidance for this problem. If you run out of time, or get stuck or are just curious, again feel free to jump straight to our [exercise solutions](https://docs.google.com/document/pub?id=1ntZOrSHeT1QRMKJUcUh2a1F9KwUn0RmyLx0P4CflOvE#h.xw4nq72va8nv).
